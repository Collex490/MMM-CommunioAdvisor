    ...
    messages: [
      {
        role: "system",
        content: [
          "Du analysierst Comunio- und Kickbase-Screenshots für ein MagicMirror-Modul.",
          ...
          "Die Gerüchteküche ist eine harmlose Sportmedien-Parodie im WM-2026-Rollenspiel."
        ].join(" ")
      },
      {
        role: "user",
        content: [
          {
            ...
            text: [
              ...
              `Vom Nutzer gesetzter Screenshot-Modus: ${screenTypeHint}. Wenn der Modus nicht auto ist, verwende ihn für source.screenType.`,
              "Erstelle in recommendations kurze, nutzbare Manager-Infos statt Meta-Erklaerungen. Keine Sätze wie 'im Screenshot ist nur...' oder 'keine Spieler sichtbar' als Kacheltext verwenden.",
              ...
              "Wenn source.screenType transfermarket ist, muss recommendations.buy den besten sichtbaren Spieler enthalten, der wirklich auf dem Transfermarkt angeboten wird. Nutze keine Spieler aus dem eigenen Kader als Kaufempfehlung. Wenn kein klarer Marktspieler erkennbar ist, lasse recommendations.buy leer oder nutze einen neutralen offenen Hinweis, aber erfinde keinen Spieler.",
              "Wenn source.screenType transfermarket ist, extrahiere zusaetzlich marketCandidates als Array mit player, price, seller, reason und priority. Das sind nur Spieler, die auf dem Transfermarkt angeboten werden, keine eigenen Kaderspieler.",
              "Wenn source.screenType squad ist, muss recommendations.sell zwingend einen echten Verkaufskandidaten aus dem sichtbaren Kader enthalten und recommendations.risk zwingend ein echtes Startelf-/Rollenrisiko aus dem Kader oder der Aufstellung. Nutze dafür sichtbare Spielernamen.",
              ...
              "Klassifiziere source.screenType möglichst exakt als squad, transfermarket, transfernews, budget, standings oder lineup.",
              ...
              "Wenn source.screenType transfermarket ist, geht es um aktuell angebotene Spieler auf dem Markt. Fuettere damit recommendations.buy und marketCandidates, aber schreibe keine Marktangebote in transferTicker.",
              "Wenn source.screenType transfernews ist, geht es um abgeschlossene Käufe/Verkäufe der Liga. Extrahiere nur dann transferTicker als Array mit action, player, club und price. Beispiele für action: gekauft, verkauft. Ignoriere alle Zeilen mit Computer, Markt, listed, gelistet oder freien Marktangeboten.",
              ...
              "Keine Arrays für recommendations.buy, recommendations.sell, recommendations.risk oder rumorKitchen verwenden."
            ].join(" ")
          },
          {
            type: "image_url",
